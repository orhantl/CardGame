...
class HandServiceTest {
    ...
    void should_return_ordered_hand() {
        ...
        List<Card> orderedHand = handManager.getOrderedHand(hand, randomOrderColors, randomOrderValues);
